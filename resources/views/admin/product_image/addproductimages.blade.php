		...
		<div class="row">
			<div class="col-md-12">
				<div class="box">
					...
					<div class="box-body">
								...
								<table id="example1" class="table table-bordered table-striped">
									...
									<tbody class="contentImages">
										...
										<tr>
											...
											<td><img src="{{asset('').'/'.$products_image->image}}" alt=""
													width=" 100px"></td>
											<!--<td>{{ $products_image->sort_order }}</td>-->
											<td>{{ $products_image->htmlcontent }}</td>
											<td>
												<a class="badge bg-light-blue editProductImagesModal"
													products_id='{{ $products_image->products_id }}'
													id="{{ $products_image->id }}"><i class="fa fa-pencil-square-o"
						...
						<div class="box-footer text-center">
							<a href="{{ URL::to("admin/products")}}"
								class="btn btn-primary">{{ trans('labels.SaveUpdate') }}</a>
						</div>
					</div>
					...
					<div class="modal fade" id="addImagesModal" tabindex="-1" role="dialog"
						...
						<div class="modal-dialog" role="document">
							<div class="modal-content">
								...
								{!! Form::open(array('url' =>'admin/addNewProductImage', 'name'=>'addImageFrom',
								'id'=>'addImageFrom', 'method'=>'post', 'class' => 'form-horizontal',
								'enctype'=>'multipart/form-data')) !!}
								{!! Form::hidden('products_id', $result['data']['products_id'],
								array('class'=>'form-control', 'id'=>'products_id')) !!}

								{!! Form::hidden('sort_order', count($result['products_images'])+1,
								array('class'=>'form-control', 'id'=>'sort_order')) !!}

								<div class="modal-body">

									<div class="form-group">
										<label for="name"
											class="col-sm-2 col-md-4 control-label">{{ trans('labels.Image') }}</label>
									...
									<div class="form-group">
										<label for="name"
											class="col-sm-2 col-md-4 control-label">{{ trans('labels.Description') }}
										</label>
										<div class="col-sm-10 col-md-8">
											{!! Form::textarea('htmlcontent', '', array('class'=>'form-control',
											'id'=>'htmlcontent', 'colspan'=>'3' )) !!}
											<span class="help-block"
												style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
									...
									<div class="alert alert-danger addError" style="display: none; margin-bottom: 0;"
										role="alert"><i class="icon fa fa-ban"></i>
										{{ trans('labels.ChooseImageText') }} </div>
								...
								<div class="modal-footer">
									...
									<button type="button" class="btn btn-primary"
										id="addImage">{{ trans('labels.AddImage') }}</button>
								</div>
								{!! Form::close() !!}
							</div>
						</div>
					...
					<div class="modal fade" id="editProductImagesModal" tabindex="-1" role="dialog"
						aria-labelledby="editProductImagesModalLabel">
						<div class="modal-dialog" role="document">
