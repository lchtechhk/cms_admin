        ...
        <div class="box">
          <div class="box-header">
            ...
            <div class="box-tools pull-right">
            	<a href="{{ URL::to('admin/addattributes')}}" type="button" class="btn btn-block btn-primary">Add New Options</a>
            </div>
          </div>
              ...
              <table id="" class="table table-bordered table-striped">
                  ...
                  <tr @if($key++==0) id="content_<?=$result_data->products_options_id.'_'.$result_data->languages_id?>" @endif>
                        ...
                        <td>
                            ...
                            <a href="javascript:void(0)" value_id = '<?=$values_data->products_options_values_id?>' language_id = '<?=$result_data->languages_id?>' option_id = '<?=$values_data->products_options_id?>' data-toggle="tooltip" data-placement="bottom" title="{{ trans('labels.DeleteValue') }}" class="badge bg-red delete-value"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
                </tr>
                ...
                <div class="col-xs-12 text-right">
               	 ...
               	 {{$result['attributes']->links('vendor.pagination.default')}}
