...
<div class="modal fade" id="addressDialog" tabindex="-1" role="dialog" aria-labelledby="addressLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      @endif
      {!! Form::text('customer_id',  empty($result['address']['customer_id']) ? '' : print_value($result['operation'],$result['address']['customer_id']), array('class'=>'form-control', 'id'=>'customer_id')) !!}
