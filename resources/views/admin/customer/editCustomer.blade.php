                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10 col-md-4">
                        {!! Form::text('customers_firstname', $result['customers'][0]->customers_firstname,
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10 col-md-4">
                        {!! Form::text('customers_lastname', $result['customers'][0]->customers_lastname,
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10 col-md-4">
                        <label>
                          <input @if($result['customers'][0]->customers_gender == 1 or
                          empty($result['customers'][0]->customers_gender)) checked @endif type="radio"
                          name="customers_gender" value="1" class="minimal" checked > {{ trans('labels.Male') }}
                        </label><br>

                        <label>
                          <input @if( !empty($result['customers'][0]->customers_gender) and
                          $result['customers'][0]->customers_gender == 0) checked @endif type="radio"
                          name="customers_gender" value="0" class="minimal"> {{ trans('labels.Female') }}
                        </label>
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-sm-10 col-md-4">
                        ...
                        <br>
                        {!! Form::hidden('oldImage', $result['customers'][0]->customers_picture,
                        array('id'=>'oldImage')) !!}
                        @if(!empty($result['customers'][0]->customers_picture))
                        <img width="150px" src="{{asset('').'/'.$result['customers'][0]->customers_picture}}"
                          class="img-circle">
                        @else
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10 col-md-4">
                        {!! Form::text('customers_dob', $result['customers'][0]->customers_dob,
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10 col-md-4">
                        {!! Form::text('customers_telephone', $result['customers'][0]->customers_telephone,
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10 col-md-4">
                        {!! Form::text('customers_fax', $result['customers'][0]->customers_fax,
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10 col-md-4">
                        {!! Form::email('email', $result['customers'][0]->email, array('class'=>'form-control
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10 col-md-4">
                        <select class="form-control" name="status">
                          <option value="active"
                            {{print_selected_value($result['operation'],'active',$result['customers'][0]->status)}}>
                            {{ trans('labels.Active') }}</option>
                          <option value="inactive"
                            {{print_selected_value($result['operation'],'inactive',$result['customers'][0]->status)}}>
