            ...
            <div class="row">
              <div class="col-xs-12">
                <div class="box box-info"><br>
                  ...
                  <div class="box-body">
                    {!! Form::open(array('url' =>'admin/updateArea/'.$result["area"]->id, 'method'=>'post', 'class' =>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10 col-md-4">
                        {!! Form::text('id', $result['area']->id , array('class'=>'form-control',
                        'id'=>'id','readonly'=>'true')) !!}
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10 col-md-4">
                        <select name="city_id" class='form-control field-validate'>
                          ...
                          <option @if( $city->id == $result['area']->city_id)
                            selected
                            @endif
                    ...
                    <div class="form-group">
                      <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.AreaName') }}<span
                          style="color:red">★</span></label>
                      <div class="col-sm-10 col-md-4">
                        {!! Form::text('name', $result['area']->name, array('class'=>'form-control field-validate',
                        'id'=>'area_name'))!!}
                        <span class="help-block"
                          style="font-weight: normal;font-size: 11px;margin-bottom: 0;">{{ trans('labels.AreaNameText') }}</span>
                        <span class="help-block hidden">{{ trans('labels.textRequiredFieldMessage') }}</span>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10 col-md-4">
                        {!! Form::text('code', $result['area']->code, array('class'=>'form-control',
                        'id'=>'area_code'))!!}
                        <span class="help-block"
                          style="font-weight: normal;font-size: 11px;margin-bottom: 0;">{{ trans('labels.AreaCodeText') }}</span>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.CreateDate') }}<span
                          style="color:red">★</label>
                      <div class="col-sm-10 col-md-4">
                        {!! Form::text('create_date', $result['area']->create_date, array('class'=>'form-control',
                    ...
                    <div class="form-group">
                      <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.EditDate') }}<span
                          style="color:red">★</label>
                      <div class="col-sm-10 col-md-4">
                        {!! Form::text('edit_date', $result['area']->edit_date, array('class'=>'form-control',
