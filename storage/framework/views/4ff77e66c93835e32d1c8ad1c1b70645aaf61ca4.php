        ...
        <div class="box">
          <div class="box-header">
            ...
            <div class="box-tools pull-right">
            	<a href="<?php echo e(URL::to('admin/addpage')); ?>" type="button" class="btn btn-block btn-primary"><?php echo e(trans('labels.AddPage')); ?></a>
            </div>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
            ...
            <div class="row">
              <div class="col-xs-12">
                <table id="example1" class="table table-bordered table-striped">
                  <thead>
                    <tr>
                     ...
                     <!-- <th><?php echo e(trans('labels.Page Type')); ?></th>-->
                ...
                <div class="col-xs-12 text-right">
                	<?php echo e($result["pages"]->links('vendor.pagination.default')); ?>
