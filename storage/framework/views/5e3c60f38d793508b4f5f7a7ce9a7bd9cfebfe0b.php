      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title"><?php echo e(trans('labels.ManageLabel')); ?> </h3>
          </div>
                            ...
                            <?php echo Form::open(array('url' =>'admin/updateAppLabel', 'name'=>'form', 'method'=>'post', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data')); ?>
								...
								<?php $j=0;?>
									<?php $__currentLoopData = $result['languages']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$languages): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>                   
										<?php if(!empty($labels_data1[$j]->language_id) and $languages->languages_id == $labels_data1[$j]->language_id): ?>
                              ...
                              <div class="box-footer text-center">
                                <a href="<?php echo e(URL::to('admin/dashboard/this_month')); ?>" type="button" class="pull-left btn btn-default"><?php echo e(trans('labels.back')); ?></a>
