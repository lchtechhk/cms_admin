      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">Listing All Options </h3>
            <div class="box-tools pull-right">
            	<a href="<?php echo e(URL::to('admin/addattributes')); ?>" type="button" class="btn btn-block btn-primary">Add New Options</a>
            </div>
          </div>
          ...
          <div class="box-body">
            ...
            <div class="row">
              ...
              <table id="" class="table table-bordered table-striped">
                  <thead>
                    <tr>
                      <th><?php echo e($result_data->products_options_name); ?> (<?php echo e($result_data->name); ?>)</th>
                      <th width="40%">
                  ...
                  <tr <?php if($key++==0): ?> id="content_<?=$result_data->products_options_id.'_'.$result_data->languages_id?>" <?php endif; ?>>
                  		<td>
                            ...
                            <?php echo Form::open(array('url' =>'admin/updateattributevalue', 'method'=>'post', 'class' => 'form-horizontal form-validate editvalue-form', 'enctype'=>'multipart/form-data')); ?>
                                ...
                                <button name="cancelValue" type="button" class="btn btn-warning cancel-value" value = '<?=$result_data->products_options_id.$values_data->products_options_values_id?>'><i class="fa fa-times "></i> Cancel</button>
                        ...
                        <td>
                            ...
                            <a href="javascript:void(0)" value_id = '<?=$values_data->products_options_values_id?>' language_id = '<?=$result_data->languages_id?>' option_id = '<?=$values_data->products_options_id?>' data-toggle="tooltip" data-placement="bottom" title="<?php echo e(trans('labels.DeleteValue')); ?>" class="badge bg-red delete-value"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
                </tr>
                ...
                <div class="col-xs-12 text-right">
               	 ...
               	 <?php echo e($result['attributes']->links('vendor.pagination.default')); ?>
