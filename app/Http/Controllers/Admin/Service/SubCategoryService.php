...
class SubCategoryService extends BaseApiService{
    ...
    function redirect_view($result,$title){
        ...
        switch($result['operation']){
            ...
            case 'add':
                try{
                    ...
                    foreach ($result['name'] as $language_id => $name) {
                        ...
                        $add_sub_category_description_result = $this->SubCategoryDescriptionService->add($param,"Successful","Fail");
                    ...
                    $result['sub_category'] = !empty($sub_category_array) &&  sizeof($sub_category_array) > 0 ? $sub_category_array[0] : array();
                    // Log::info('[result] -- sub_category : ' .json_encode($result));
            ...
            case 'edit':
                try{
                    ...
                    foreach ($result['name'] as $language_id => $name) {
                        ...
                        $param['name'] = $name;
                        $param['label'] = $result['label'];
                        $update_sub_category_description_result = $this->SubCategoryDescriptionService->updateByMultipleKey($param,array("sub_category_id","language_id",),array($result['sub_category_id'],$language_id),"Successful","Fail");
            ...
            case 'delete': 
                try{
                    $delete_sub_category_result = $this->deleteByKey_Value("sub_category_id",$result['id'],"Successful","Fail");
                    ...
                    $delete_sub_category_description_result = $this->SubCategoryDescriptionService->deleteByKey_Value("sub_category_id",$result['id'],"Successful","Fail");
